...
export function CheckCircle({ color }: CloseProps) {
  ...
  <path d="M15.5 10.5L11.75 14.25" stroke="${color || '#fff'}" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
